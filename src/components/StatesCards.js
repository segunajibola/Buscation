...
const StatesCards = ({ destination }) => {
  return (
    <div className="max-w-full pt-20 lg:max-w-full mx-auto px-4 lg:px-8 py-6 dark:bg-gray-800"> 
            <h2 className="text-xl text-gray-900 dark:text-white text-center">Explore all states</h2>
            <p className="mt-2 text-gray-600 dark:text-white text-center">Collecton of great places to tour in each states.</p>
